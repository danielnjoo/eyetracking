...
function [stimMat,stim] = generateTrialSequenceProbabilisticCT
...
stim.uniqCombination = nchoosek(1:stim.nCue,stim.nCueSite); % matrix of unique combinations (does not include mirror image)
stim.matCombination = [stim.uniqCombination; stim.uniqCombination(:,[2 1])]; % include mirror images
...
stim.probDist = [0.95 0.80 0.65 0.5]; % probabilty distributions 
